...
let mongo = try! MongoKitten.Server("mongodb://mainvolume:test123@ds021036.mlab.com:21036")
// Server("mongodb://127.0.0.1:27017") //

//let mongo = try Server("mongodb://127.0.0.1:27017")
let db:MongoKitten.Database = mongo["henk"]
let cl:MongoKitten.Collection = db["users"]
do {
    
    try mongo.connect()
    drop.get("hej") { req in
//        let f = try Fr13nd(øname: "hej", t_id: "12345")
//        do {
//            try f.save(db: cl)
//        }
//        return f
        try cl.insert(["bob": true])
